...
MC_DEFINE_SINGLETON(MCModelHelper)
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
	...
	NSString *storePath = [[self applicationDocumentsDirectory] stringByAppendingPathComponent:@"MyCloset.sqlite"];
	/*
	 Set up the store.
	...
	if (![fileManager fileExistsAtPath:storePath]) {
		NSString *defaultStorePath = [[NSBundle mainBundle] pathForResource:@"MyCloset" ofType:@"sqlite"];
		if (defaultStorePath) {
...
{
	//use NSEntityDescription's insertNewObjectForEntityForName method to generate entity's accessor method dynamically
